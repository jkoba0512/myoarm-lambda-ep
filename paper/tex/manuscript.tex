...
%% Final submission target style: sn-basic (Bio Cyb / SPBASIC name-year).
%% Using `default` for the MVP because the stop-gap thebibliography list
%% is not compatible with natbib author-year mode. Switch back to
%% [sn-basic] when references are migrated to a separate references.bib.
...
controller. \textbf{Feldman's $\lambda$-equilibrium-point hypothesis} (Feldman
...
(Saunders and Knill 2003; Sarlegna and Sainburg 2009) provides a slow ($\approx$
...
cord, \textbf{$\gamma$-compatible stretch reflexes} (Prochazka 1989; Loeb
...
\item
  \emph{Direction error}: \(\pm 5\textdegree \), chosen as one-fifth of the typical
...
\(p < 10^{-25}\); Fig. 1a) and reduces root-mean-square jerk by $\approx$ 40 \%
...
visible in Fig. 2a ($\approx$ 1.06 m s\(^{-1}\) at \(t = 0.05\) s, discussed
...
s\(^{-1}\) followed by oscillatory residuals (Fig. 2a, gray), the pure $\lambda$
...
Direction error [\textdegree ]            & $7.2 \pm 4.8$     & $8.1 \pm 4.7$              & $+0.19$ & $0.039$  & * \\
...
%%========================================================================%%
%% References --- STOP-GAP form (thebibliography environment).             %%
%% TODO: convert to references.bib + \bibliographystyle{sn-basic} +       %%
%% \bibliography{references} for SPBASIC name-year style. The in-text     %%
%% citations also need to be rewritten from plain "(Author year)" to      %%
%% \citet{key} / \citep{key} at that time.                                %%
%%========================================================================%%
...
Caggiano V, Wang H, Durandau G, Sartori M, Kumar V (2022) MyoSuite: a contact-rich simulation suite for musculoskeletal motor control. In: Proceedings of the 4th Annual Learning for Dynamics and Control Conference (L4DC). PMLR 168:492--507.

\bibitem{feldman1966}
Feldman AG (1966) Functional tuning of the nervous system with control of movement or maintenance of a steady posture. II. Controllable parameters of the muscles. Biofizika 11:498--508.

\bibitem{feldman1986}
Feldman AG (1986) Once more on the equilibrium-point hypothesis ($\lambda$ model) for motor control. J Mot Behav 18:17--54.

\bibitem{feldmanlevin1995}
...
\bibitem{hasani2022}
Hasani R, Lechner M, Amini A, Liebenwein L, Ray A, Tschaikowski M, Teschl G, Rus D (2022) Closed-form continuous-time neural networks. Nat Mach Intell 4:992--1003.
...
\bibitem{loeb1984}
Loeb GE (1984) The control and responses of mammalian muscle spindles during normally executed motor tasks. Exerc Sport Sci Rev 12:157--204.

\bibitem{morasso1981}
Morasso P (1981) Spatial control of arm movements. Exp Brain Res 42:223--227.

\bibitem{prochazka1989}
Prochazka A (1989) Sensorimotor gain control: a basic strategy of motor systems? Prog Neurobiol 33:281--307.

\bibitem{sarlegnasainburg2009}
...
\bibitem{schumacher2023}
Schumacher P, H{\"a}ufle DFB, B{\"u}chler D, Schmitt S, Martius G (2023) Natural and robust walking using reinforcement learning without demonstrations in high-dimensional musculoskeletal models. arXiv:2309.02976.

\bibitem{todorov2012}
Todorov E, Erez T, Tassa Y (2012) MuJoCo: a physics engine for model-based control. In: 2012 IEEE/RSJ Int Conf on Intelligent Robots and Systems. pp 5026--5033.
